...
namespace P2DEngine.Games
{
    ...
    {
        public List<myPhysicsGameObject> gameObjects; // Cada escena tiene su lista de objetos. Si usted quiere hacer un objeto global (es decir, que funcione entre escenas), tendría que buscar la forma de implementarlo. La pista es que ud. puede obtener
        ...
        public myScene(myCamera camera) // Constructor.
        {
            ...
            gameObjects = new List<myPhysicsGameObject>();
        ...
        public myPhysicsGameObject Instantiate(myPhysicsGameObject go)
        {
        ...
        public myPhysicsGameObject Destroy(myPhysicsGameObject go)
        {
            if(gameObjects.Contains(go))
            {
